...
class Circuits {
	...
	draw() {
		...
		ctx.strokeStyle = 'rgba(3, 199, 224, 1)';
...
class Things {
	...
	setLight(lightRadius) {
		...
		gradient.addColorStop(1, "rgba(24, 129, 141, .5)");
		...
		const radWidth = this.ghostSuperRadial.width = lightRadius * 2;
		const radHeight = this.ghostSuperRadial.height = lightRadius * 3;
